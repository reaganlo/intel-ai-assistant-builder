...
<p align="justify">This folder contains sample code for a <strong>terminal-based client</strong> for Intel® AI Super Builder. We believe this will assist developers in quickly prototyping new features and integrations with Intel® AI Super Builder Service.</p>
